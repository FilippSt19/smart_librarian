...
class Config:
    """Legacy uppercase settings bridge for modules using Config.* constants."""
    ...
    BOOK_SUMMARIES_PATH = _settings.book_summaries_path
    SUMMARIES_JSON_PATH = _settings.summaries_json_path
    DEFAULT_N_RESULTS = _settings.default_n_results
